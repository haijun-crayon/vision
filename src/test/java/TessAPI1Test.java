...
public class TessAPI1Test {
    ...
    public void testTessBaseAPISetPageSegMode() {
        ...
        int mode = ITessAPI.TessPageSegMode.PSM_AUTO;
    ...
    public void testTessBaseAPIGetPageSegMode() {
        ...
        TessAPI1.TessBaseAPISetPageSegMode(handle, ITessAPI.TessPageSegMode.PSM_SINGLE_CHAR);
        int expResult = ITessAPI.TessPageSegMode.PSM_SINGLE_CHAR;
